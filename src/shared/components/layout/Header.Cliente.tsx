// src/shared/layout/header/Header.Cliente.tsx
import React from 'react';
import { Link } from 'react-router-dom';
import { HEADER_MENU_LINKS } from '../../../constants';
import type { RoleMenuProps } from './Header.Admin';

const HeaderClienteMenu: React.FC<RoleMenuProps> = ({ closeMenu, onLogout }) => {
  return (
    <>
      {HEADER_MENU_LINKS.CLIENTE.map((link) => (
...
export default HeaderClienteMenu;
