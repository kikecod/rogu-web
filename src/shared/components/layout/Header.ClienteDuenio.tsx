// src/shared/layout/header/Header.ClienteDuenio.tsx
import React from 'react';
import { Link } from 'react-router-dom';
import { HEADER_MENU_LINKS } from '../../../constants';
import type { RoleMenuProps } from './Header.Admin';

const HeaderClienteDuenioMenu: React.FC<RoleMenuProps> = ({ closeMenu, onLogout }) => {
  return (
    <>
      {HEADER_MENU_LINKS.CLIENTE_DUENIO.map((link) => (
...
export default HeaderClienteDuenioMenu;
