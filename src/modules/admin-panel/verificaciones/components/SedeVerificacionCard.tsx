...
const SedeVerificacionCard: React.FC<SedeVerificacionCardProps> = ({
  ...
  const handleVerLicencia = () => {
    // 1. Construimos la URL directa al Backend
    // IMPORTANTE: Asegúrate de que esta URL sea correcta según tu API
    const url = `http://localhost:3000/api/sede/${sede.idSede}/licencia`;
    
    // 2. Abrimos en una nueva pestaña
    // El navegador seguirá la redirección a S3 sin bloquearse por CORS
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3 pt-4 border-t border-gray-200">
          <button
            ...
            title="Ver licencia en nueva pestaña"
          >
