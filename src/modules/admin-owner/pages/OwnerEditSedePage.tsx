...
const OwnerEditSedePage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchSede = async () => {
            ...
            try {
                ...
                console.error(err);
                setError(err instanceof Error ? err.message : 'Error al cargar la sede');
            } finally {
                setIsLoading(false);
            }
        };

        if (isLoggedIn && isDuenio()) {
            fetchSede();
        }
    }, [id, isLoggedIn, isDuenio, user]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/sede/${id}`, {
                method: 'PATCH', // Assuming PATCH for updates, or PUT
                headers: {
            ...
            setError(err instanceof Error ? err.message : 'Error al actualizar la sede');
        } finally {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                <div className="bg-white p-8 rounded-2xl shadow-xl text-center max-w-md">
                    ...
                    <button onClick={() => navigate(ROUTES.owner.spaces)} className="px-6 py-2 bg-gray-200 rounded-lg font-medium hover:bg-gray-300 transition-colors">
                        Volver
                    </button>
                </div>
            </div>
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-30">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-bold text-gray-900">Editar Sede</h1>
                    </div>
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-gray-500 mt-2">Edita los detalles principales de tu sede.</p>
                                </div>
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-500 mt-2">Actualiza la ubicación si es necesario.</p>
                                </div>

                                <div className="space-y-4">
                                    <div className="h-[400px] rounded-2xl overflow-hidden border border-gray-200 shadow-inner relative group">
                                        <MapPicker
                                            initialLat={formData.latitud ?? DEFAULT_COORDINATES.SANTA_CRUZ.lat}
                                            initialLng={formData.longitud ?? DEFAULT_COORDINATES.SANTA_CRUZ.lng}
                        ...
                        {currentStep === 3 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-500 mt-2">Actualiza la información de contacto.</p>
                                </div>
                        ...
                        {currentStep === 4 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-500 mt-2">Revisa la información antes de guardar.</p>
                                </div>
...
export default OwnerEditSedePage;
