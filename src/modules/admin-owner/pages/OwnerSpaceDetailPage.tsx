...
import FieldManagementCard from '@/venues/components/FieldManagementCard';
import type { CanchaResumen } from '@/venues/types/venue-search.types';
import {
    getDepartments,
    getCitiesByDepartment,
    getDistrictsByCity,
    getFullAddress
} from '@/venues/lib/boliviaData';
